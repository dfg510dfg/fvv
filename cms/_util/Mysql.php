...
class Mysql {
   ...
   public function getPassword($longitud){
       $password = "";
       if(!empty($longitud)){
           if(!is_numeric($longitud) || $longitud <= 0){$longitud=6;}
  ...
  public function getUsuario($cadena){
       ...
       try {
           //if(is_array($this->rs)){
            ...
            foreach ($this->rs as $value){
                ...
                if($value["codigo"] == $default) $this->ddlHTML .= " selected ";
                $this->ddlHTML .= ">";
        ...
        if($rsDatos == TRUE){
            ...
            if($nNumCampos>0) {
                ...
                $sTablaHTML .= "<table border=\"0\">
                                    <tr>
                                        <td><button class=\"btn btn\" type=\"button\" onclick=\"irA('INS')\">NUEVO</button></td>
                                        <td>&nbsp;&nbsp;</td>
   ...
   public function getGrillaHTMLContactenos($rs,$anchoTbl,array $sNombreCampo2,array $sAnchoCampo,array $vParam){       
        ...
        if($rsDatos == TRUE){
            ...
            if($nNumCampos>0) {
                ...
                $sTablaHTML .= "<table border=\"0\">
                                    <tr>
                                        <td><button class=\"btn btn\" type=\"button\" onclick=\"irA('UPD')\">RESPONDER</button></td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td><button class=\"btn btn\" type=\"button\" onclick=\"irA('DEL')\">ELIMINAR</button></td>
                                    </tr>
                                </table>";
