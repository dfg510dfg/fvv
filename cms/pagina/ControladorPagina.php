...
if(!empty($_POST["accion"])){ 
    ...
    if(isset($_POST["txttag1"])) $sTag1 = $_POST["txttag1"]; else $sTag1="";
    if(isset($_POST["googleAn"])) $sgoogleAn = htmlentities($_POST["googleAn"], ENT_QUOTES); else $sgoogleAn="";
    ...
    $objPaginaEntidad->setDirecimag($sTag1);
    $objPaginaEntidad->setScript($sgoogleAn);
