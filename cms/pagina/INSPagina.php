		...
		<input type="hidden" id="cmbTipo" name="cmbTipo" value="1"/>
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="4"><input type="text" id="txttag" name="txttag" placeholder="title" data-required="true" style="width: 550px;" /> </td>                        
                    </tr>
                    <tr><td colspan="5" height="15"></td></tr>
                    <tr>
                        <td><label for="txttag">Descripcion Web* :</label> </td>
                        <td colspan="4"><input type="text" id="txttag1" name="txttag1" placeholder="descripcion" data-required="true" style="width: 550px;" /> </td>                        
                    </tr>
                    <tr><td colspan="5" height="15"></td></tr>
                    <tr>
                        <td><label for="txtnombre">Google Analytics :</label> </td>
                        <td colspan="3"><textarea type="text" id="googleAn" name="googleAn" placeholder="Ingresar Script"  style="width: 550px;" ></textarea> </td>                        
                    </tr>
                    <tr><td colspan="5" height="15"></td></tr>
