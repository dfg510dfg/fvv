        ...
        <div style="width: auto; border-radius:10px; border:solid 5px #000;background-image:url(../img/bgpanel.jpg);">
            ...
            <br/> 
                ...
                <table>
                    ...
                    <tr>
                        <td valign="top"><label for="txttag">Tag * :</label> </td>
                        <td><input type="text" id="txtnombre" name="txttag" value="<?=$vFila["descriptag"]?>" placeholder="Nombre" data-required="true" /> </td>
                    </tr>
