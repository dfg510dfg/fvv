...
if (!isset($valses)){ header("Location: ../login/logout.php");}
        ...
        <form id="demo-form" ata-validate="parsley" method="post" enctype="multipart/form-data" action="ControladorPopup.php">
         ...
         <div style="width: auto; border-radius:10px; border:solid 5px #000;background-image:url(../img/bgpanel.jpg);">
            ...
            <div style="width: 900px;height:40px;background-color:grey; text-align: left;color:#fff;padding-left: 5px;">
                <h1 style="padding: 0; margin: 0;">Insertar nuevo Pop-up
            ...
            <br/>    
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="4"><input type="text" id="txtancho" name="txtancho" placeholder="" data-required="true" style="width: 50px;" /> </td>                        
                    </tr>
                    <tr>
                        <td><label for="txtalto">Alto :</label> </td>
                        <td colspan="4"><input type="text" id="txtalto" name="txtalto" placeholder="" data-required="true" style="width: 50px;" /> </td>                        
                    </tr>
                    <tr><td colspan="5" height="15"></td></tr>
                    
                    <tr>
                        <td><label for="cmbPosicion">Posicion :</label> </td>
                        <td>
                            <select name="cmbPosicion" id="cmbPosicion" data-required="true" title="Seleccionar orden">
                                    <option value="0" selected>[-- seleccionar posicion --]</option>
