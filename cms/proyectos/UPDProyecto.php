...
$objDatos = new Datos();
$vFila=$objDatos->getConsulta(array("f_proyecto",$_GET["id"]));
$dirses = new Sesion();
        ...
        <form id="demo-form" ata-validate="parsley" method="post" enctype="multipart/form-data" action="ControladorProyecto.php">
         ...
         <div style="width: auto; border-radius:10px; border:solid 5px #000;background-image:url(../img/bgpanel.jpg);">
            ...
            <div style="width: 900px;height:40px;background-color:grey; text-align: left;color:#fff;padding-left: 5px;">
                <h3 style="padding: 0; margin: 0;">Actualiza proyecto <?=$vFila["titulo"]?>
            ...
            <br/>    
                ...
                <table>
                    <tr>
                        <td valign="top"><label for="txtcodigo">Codigo de proyecto * :</label> </td>
                        <td><input type="text" id="txtcodigo" name="txtcodigo" value="<?=sprintf("%07d",$vFila["idproyecto"])?>" placeholder="Codigo" readonly /> </td>
                        <td colspan="3"></td>
                    </tr>
...
<!--                    <tr>
                    ...
                    <tr>
                            ...
                            <td><select name="cmbContenido" id="cmbContenido" style="width:165px;" onclick="enlacesMenu();">
                                <option value="1" <?if($vFila["contenido"]==1){echo selected;}?>>SIN ENLACE</option>
                                <option value="2" <?if($vFila["contenido"]==2){echo selected;}?>>ENLACE INTERNO</option>
                                <option value="3" <?if($vFila["contenido"]==3){echo selected;}?>>ENLACE EXTERNO</option>
                            </select></td>
                        </tr>
                        <tr id="enlaceInterno">
